                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:#0a7df0;font-weight:1em;">
                            <div style="padding-right:0px;" >
                                <img height="60"src="./images/hicon.jpg">
                            </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="viewcustomers.php" style="color:#0a7df0;font-weight:1em;">
                            <div style="padding-left:20px;" >
                                <img height="60"src="./images/cust.png">
                            </div>
                            View Customers
                        </a> 
                    </li>
...
<div class="row">
    ...
    <div style="padding-top:2%;display:inline;"><h4 class="font-weight-bold" style="color:#0a7df0;font-size:2em;;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Customer Details</h4>
    </div>
        <br><br>
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                    ...
                    <span class="font-weight-bold" style="color:#0a7df0;font-size:1.8em;line-height:1em;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Money Transfer</span>
                    </div><br><br>
                ...
                $pass ="";
                $dbName='ashblogs';
                $db=mysqli_connect($hostname,$username,$pass,$dbName);
